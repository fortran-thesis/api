...
export const findMoldById = async (id: string) => getDocumentsByField(collection, 'id', id);
export const findMoldByName = async (name: string) => getDocumentsByField(collection, 'name', name);
