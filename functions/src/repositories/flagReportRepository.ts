...
export const addFlagReport = async (data: FlagReportBase) =>
  addDocument(collection, data);
export const findFlagReportById = async (id: string) =>
...
export const updateFlagReport = async (
  id: string,
  updatedData: Partial<FlagReportBase>
) => updateDocument(collection, id, updatedData);
export const deleteFlagReport = async (id: string) =>
  deleteDocument(collection, id);
export const softDeleteFlagReport = async (id: string) =>
